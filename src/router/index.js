    ...
    children: [
      {
        ...
        name: 'editTemplate',
        hidden: true,
        meta: { title: '编辑产检模板', id: 'Template.EditTemplate', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'addTemplate',
        hidden: true,
        meta: { title: '新增科普知识', id: 'Knowledge.AddTemplate', affix: true }
      },{
        path: 'edit',
        component: () => import('@/views/knowledge-library/add-edit-science'),
        name: 'editTemplate',
        hidden: true,
        meta: { title: '编辑科普知识', id: 'Knowledge.EditTemplate', affix: true }
      },
    ]
  }
]
