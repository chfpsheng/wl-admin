<template>
  <div class="app-container">
    <div class="add-btn">
      <el-button class="pa-btn" type="primary" @click="addTemplate" :autofocus="true">
          ...
          >
            ...
            >
              ...
              <div class="content-warp" v-else-if="item.columnType == 'TEXT'">
                ...
                >
                  <el-input
                    ...
                    type="textarea"
                    class="column-textarea textarea"
              ...
              <div class="content-warp" v-else-if="item.columnType == 'IMAGE'">
                <img-list :activeType="imgActiveType" v-model="item0[item.columnCode]" @change="imgListChange" />
              </div>
...
export default {
  ...
  methods: {
    ...
    addTemplate() {
      ...
      this.$nextTick(() => {
        let p = document.getElementById("templateId");
    ...
    async queryTableHeader() {
      ...
      this.$emit('table-header-load','start')
      ...
      if (result && result.code === 200) {
        ...
        this.$emit('table-header-load','end')
      }
    },
