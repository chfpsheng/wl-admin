<template>
  <div class="upload-box">
    <el-upload
      ...
      :class="[photoList.length < imgLength ? 'img--upload' : 'img--disupload']"
    >
      <i class="el-icon-plus" />
    </el-upload>
    <el-dialog :visible.sync="dialogVisible" :modal="modal" append-to-body>
...
export default {
  ...
  methods: {
    ...
    async uploadFile(params) {
      ...
      const isLt = file.size / 1024 / 1024 < this.fileSizeLimit
      if (!isImg) {
