<template>
  <div v-show="showPreviewer" class="image-previewer-wrapper" @mousewheel="handleMouseWheel">
    ...
    <i class="el-icon-back prev-button" @click="goPrev" />
    <i class="el-icon-right next-button" @click="goNext" />
    <div class="actions-bar">
      <i class="el-icon-zoom-out" @click="zoomOut" />
      <i class="el-icon-zoom-in" @click="zoomIn" />
      <i class="el-icon-refresh-left" @click="rotateLeft" />
      <i class="el-icon-refresh-right" @click="rotateRight" />
