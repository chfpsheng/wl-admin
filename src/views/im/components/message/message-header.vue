 ...
 * @LastEditTime: 2021-10-27 10:44:25
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: \management-system\src\views\im\components\message\message-header.vue
-->
<template>
  ...
  computed: {
    ...
    from() {
      ...
      if (this.isMine) {
        ...
        return this.message.nick || this.message.userID
      }
