...
const previewPath = process.env.VUE_APP_PREVIEW_BASE_API + '/#/service/detail?id='
Vue.prototype.$previewPath = previewPath

// 图片上传路径
const uploadUrl = process.env.VUE_APP_BASE_API + '/cloud-baseinfo/fileUploadInfo/fileUpload'
