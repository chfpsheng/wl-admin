  ...
  <div class="flex flex-column">
      ...
      <el-row :gutter="40">
        ...
        <el-col :span="8" :xl="4">
          <div class="filter-item">
            <label>启停状态</label>
            <pa-select
              :value.sync="pageQuery.startingStatus"
              :options="statusList"
            ></pa-select>
          </div>
        </el-col>
        ...
        <el-col :span="8" :xl="4">
          <div class="filter-item">
            <label>网络类型</label>
            <pa-select
              :value.sync="pageQuery.networkType"
    ...
    <div class="flex-main table-view page-content flex flex-column">
      <div class="table-handler text-right">
        <el-button type="primary" class="pa-btn" @click="onStart(row)">
          <i class="iconfont icon-s_tianjia1"></i>
          <span> 启动</span>
        </el-button>
        <el-button type="primary" class="pa-btn" @click="onStop(row)">
          <i class="iconfont icon-s_tianjia1"></i>
          <span> 停止</span>
        </el-button>
      </div>
